...
class MainClassTimeLimitSetPage(EduManagePage):
    """主体班时限设置主页面"""
    ...
    def go_course_set_page(self, name):
        ...
        from djw.page.smart_school_sys.教务管理.教学设置.主体班时限设置.course_set_detail_page import CourseSetDetailPage
        return CourseSetDetailPage(self.driver)